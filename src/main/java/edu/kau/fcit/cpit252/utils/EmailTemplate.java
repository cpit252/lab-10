...
// This class uses a responsive HTML invoice template from: https://github.com/sparksuite/simple-html-invoice-template
...
public class EmailTemplate {
    ...
    public String getEmailTemplate(String title, String invoiceId, Date issueDate, List<Product> products) {
        ...
        for (Product p : products) {
            itemsListHTML += "<tr class=\"item\">";
            itemsListHTML += "<td>" + p.getName() + "<td>";
